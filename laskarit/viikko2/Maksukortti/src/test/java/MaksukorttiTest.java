...
public class MaksukorttiTest {
    ...
    @Test
    public void kortinSaldolleEiVoiLadataMiinusta() {
        kortti.lataaRahaa(-500);
        assertEquals("Kortilla on rahaa 10.0 euroa", kortti.toString());
    }
    
    @Test
    public void edullisellaLounaallaSaadaanTiliNollaan() {
    ...
    @Test
    public void maukkaallaLounaallaSaadaanTiliNollaan() {
        Maksukortti maukas = new Maksukortti(4);
